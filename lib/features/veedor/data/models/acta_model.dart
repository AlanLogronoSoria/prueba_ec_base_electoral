...
class ActaModel extends Acta {
  ...
  factory ActaModel.fromMap(Map<String, dynamic> map, String id) {
    return ActaModel(
      ...
      gpsLatitud: double.tryParse(map['gps_latitud']?.toString() ?? ''),
      gpsLongitud: double.tryParse(map['gps_longitud']?.toString() ?? ''),
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      if (gpsLatitud != null) 'gps_latitud': gpsLatitud.toString(),
      if (gpsLongitud != null) 'gps_longitud': gpsLongitud.toString(),
